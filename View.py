...
class View:
    ...
    def draw_welcome(self):
        ...
        self.draw_button("Start", self.SCREEN_SIZE[0] / 3 - (150 / 2), self.SCREEN_SIZE[1] * 3 / 5 - (75 / 2), 150, 75,
                         self.col_green, self.col_bright_green)
        """Draw Quit button"""
        # FIXME BUTTON POSITIONS HARDCODED, ALSO ADD CHANGES IN Game.py
        self.draw_button("Quit", self.SCREEN_SIZE[0] * 2 / 3 - (150 / 2), self.SCREEN_SIZE[1] * 3 / 5 - (75 / 2), 150,
    ...
    def draw_feedback(self, time, correct, errors_reached):
        ...
        if errors_reached:
            ...
            """Draw quit button"""
            # FIXME BUTTON POSITIONS HARDCODED, ALSO ADD CHANGES IN Game.py
            self.draw_button("Quit", self.SCREEN_SIZE[0] / 2 - (200 / 2), self.SCREEN_SIZE[1] * 4 / 5 - (100 / 2),
                             200, 100,
            ...
            # FIXME BUTTON POSITIONS HARDCODED, ALSO ADD CHANGES IN Game.py
            self.draw_button("Next trial", self.SCREEN_SIZE[0] * 1 / 3 - (150 / 2),
                             self.SCREEN_SIZE[1] * 4 / 5 - (75 / 2), 150, 75, self.col_green, self.col_bright_green)
            """Draw Quit button"""
            # FIXME BUTTON POSITIONS HARDCODED, ALSO ADD CHANGES IN Game.py
            self.draw_button("Quit", self.SCREEN_SIZE[0] * 2 / 3 - (150 / 2), self.SCREEN_SIZE[1] * 4 / 5 - (75 / 2),
                             150,
                             75, self.col_red, self.col_bright_red)
    ...
    def draw_button(self, msg, x, y, w, h, ic, ac):
        ...
        if x + w > mouse[0] > x and y + h > mouse[1] > y:
            ...
            text_surface = self.font_small.render(msg, True, self.col_darkblue, ac)
            """If mouse position is not on a button"""
        else:
            """Draw rectagle with normal colour"""
            pygame.draw.rect(self.screen, ic, (x, y, w, h))
            """Set text to msg with normal colour"""
            text_surface = self.font_small.render(msg, True, self.col_darkblue, ic)
